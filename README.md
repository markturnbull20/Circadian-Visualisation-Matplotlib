...
As a circadian scientist interested in human behaviour, I work with time-series data that capture changes across daily cycles, often over periods of 12–24 hours. These datasets contain patterns that are closely linked to the timing of biological rhythms. For example, daily rhythms in alertness and cognitive performance follow similar patterns to core body temperature ([Dijk, et al., 1992](https://doi.org/10.1111/j.1365-2869.1992.tb00021.x)).
...
The shared dataset contains participant-level averaged data to demonstrate how to create the plot. However, all statistical analyses would be conducted using trial-level data.
